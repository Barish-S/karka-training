'''This task to help you determine how many units of a specific item you can purchase within your budget.
 Additionally, the program should display the total cost of the selected item and any remaining amount after the purchase.'''
...
for item in grocery_items:
    ...
    if item["item"]==selected_item:
        ...
        is_item_not_found = True

if is_item_not_found == True:
