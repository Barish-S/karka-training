'''The Task is to check the  Students who are not eligible for quarterly exam
Instructions:
1. If the student's maths score or science score is less than 35, they are not eligible for the exam.

2. If the student's overall attendance percentage is less than 80%, they are not eligible for the exam.'''
